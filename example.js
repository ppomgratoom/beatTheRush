...
function pickItem() {
  ...
  if(direction == arr2[1]){
      alert(`${name}, your choice was to take the ${direction}. Great work!`)
      highbury()
      ...
      alert(`${name} you are going the wrong direction. Now you're now late, and missed your interview. Start again.`)
      pickItem()
  }
}
  function highbury(){
  direction = prompt(`${name} You have reached Highbury and Islington Train Station. Pick a direction to go to: ${arr3[0]} or ${arr3[1]}.`)
  alert(`you have picked to ${direction}`)
  if (direction == arr3[1]){
      alert (`${name}, you arrived at King's Cross Station. Well done.`)
      shopItem()
  }else{
      (direction == arr3[0])
      alert(`${name} you picked ${direction}. You are now going in the wrong direction. You're late for the interview. Start again.`)
      pickItem()
  }
  }
  function shopItem(){
  item2 = prompt(`${name}, you became dehydrated at King's Cross Station. You can only afford one item from the shop, what do you pick? ${arr4[0]}. ${arr4[1]}, ${arr4[2]}, ${arr4[3]}.`)
  if (item2 != arr4[1]){
      ...
      alert(`you have picked ${item2}`)
      alert(`${name}, you rehydrate yourself with the ${item2} and can continue on your journey. Phew!`)
      console.log(item2)
      kingsCross()
  }else{
      alert(`Uh oh ${name}, you chose ${item2}. You pass out from dehydration! Start again.`)
      pickItem()
  }
  }
  function kingsCross(){
  ...
  if (direction2 == arr5[2]){
    ...
    alert (`${name}, you stayed on the Piccadilly Line and arrrive at Holborn Station.`)
    holbornStation()
